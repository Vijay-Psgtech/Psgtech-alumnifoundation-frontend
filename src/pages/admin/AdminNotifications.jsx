            ...
            >
              ...
              <span
                style={{
                  ...
                  borderRadius: 20,
                  background:
                    notification.audienceType === "all" ? "#eff6ff" : "#faf5ff",
                  color:
                    notification.audienceType === "all" ? "#3b82f6" : "#9333ea",
                  fontSize: 11,
                  fontWeight: 700,
                }}
              >
        ...
        {notification.status === "pending" && (
          ...
          >
            <button
              ...
              onClick={() =>
                doAction("approve", () => onApprove(notification._id))
              }
              style={{
                display: "flex",
                alignItems: "center",
            ...
            <button
              disabled={actionLoading !== null}
              onClick={() =>
                doAction("delete", () => onDelete(notification._id))
              }
              style={{
                display: "flex",
                alignItems: "center",
...
const AdminNotifications = () => {
  ...
  const fetchNotifications = useCallback(
    async (silent = false) => {
      ...
      try {
        const res = await notificationAPI.adminGetAll(
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          ...
          <div>
            ...
            <div style={{ fontSize: 12, color: "#94a3b8" }}>
              Review and approve submitted notifications
            </div>
          </div>
        </div>
